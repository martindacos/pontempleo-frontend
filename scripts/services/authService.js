angular.module("project").factory('authService', ['Base64', '$http', '$cookieStore', '$rootScope', '$timeout', 'restService', function (Base64, $http, $cookieStore, $rootScope, $timeout, restService) {
    var service = {};
    var user = null;
